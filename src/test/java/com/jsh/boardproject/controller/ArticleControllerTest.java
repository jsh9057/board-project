...
class ArticleControllerTest {
    ...
    @Test
    void givenNewArticleInfo_whenRequesting_thenSavesNewArticles() throws Exception{
        // Given
    ...
    @Test
    void givenNothing_whenRequesting_thenReturnUpdatedArticlePage() throws Exception{
        // Given
        long articleId = 1L;
