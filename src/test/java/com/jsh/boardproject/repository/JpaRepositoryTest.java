...
class JpaRepositoryTest {
    ...
    void givenTestData_whenInserting_thenWorksFine(){
        ...
        UserAccount userAccount = userAccountRepository.save(UserAccount.of("newJsh","pw",null,null,null));
        Article article = Article.of(userAccount,"title","content");
        article.addHashtags(Set.of(Hashtag.of("new hashtag")));
    ...
    void givenArticleIdCommentIdHavingChildCommentsAndUserId_whenDeletingParentComment_thenDeletesEveryComment() {
        // Given
        long previousArticleCommentCount = articleCommentRepository.count();
